  ...
  return (
    ...
    <div className="flex flex-col justify-center  my-10 w-[90%]  max-w-7xl  ">
        <div className="flex flex-col justify-center items-center md:items-start  my-6">
            ...
            <div className="text-xl md:text-3xl text-blue-900 font-bold uppercase">Contact Us</div>
            <div className="text-sm md:text-xl text-blue-900 font-medium">We are here to help.</div>
